namespace HomeWork1.Models
{
	public static class RepositoryHelper
	{
		...
		public static View_CustomerInformStatisticsRepository GetView_CustomerInformStatisticsRepository()
		{
			var repository = new View_CustomerInformStatisticsRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static View_CustomerInformStatisticsRepository GetView_CustomerInformStatisticsRepository(IUnitOfWork unitOfWork)
		{
			var repository = new View_CustomerInformStatisticsRepository();
